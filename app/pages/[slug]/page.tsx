  ...
  if (section.sectionType === 'hero') {
    return (
      <section key={section.id} className="card" style={{ padding: 0, overflow: 'hidden' }}>
        <div style={{ padding: '32px', background: settings.imageUrl ? `linear-gradient(135deg, rgba(10,12,18,0.76), rgba(10,12,18,0.52)), url(${getDisplayImageUrl(settings.imageUrl)}) center/cover` : 'linear-gradient(135deg, rgba(221,176,79,0.18), rgba(255,255,255,0.03))' }}>
