    ...
    <div style={{ paddingTop: '30px', display: 'grid', gap: '24px' }}>
      <section className="card" style={{ padding: '28px' }}>
        ...
        <p style={{ color: 'var(--muted)', lineHeight: 1.8 }}>
          Community tools are now active. Current setting: <strong>{enabled ? 'Enabled' : 'Disabled'}</strong>.
          This feed highlights follows, comments, replies, and artwork reactions.
        </p>
      ...
      <section className="card" style={{ padding: '24px' }}>
        ...
        {activities.length === 0 ? <p style={{ margin: 0 }}>No activity yet.</p> : (
