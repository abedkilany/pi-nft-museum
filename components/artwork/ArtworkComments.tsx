      ...
      <div style={{ display: 'flex', gap: '12px', justifyContent: 'space-between' }}>
        <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
          <div className="profile-avatar" style={{ width: 44, height: 44 }}>
            {comment.author.profileImage ? <Image src={getDisplayImageUrl(comment.author.profileImage)} alt={displayName} width={44} height={44} unoptimized style={{ width: '100%', height: '100%', objectFit: 'cover' }} /> : <span>{avatarLabel(comment)}</span>}
          </div>
          <div>
