...
export const SITE_SETTING_DEFINITIONS: SiteSettingDefinition[] = [
  ...
  { key: 'review_page_statuses', label: 'Review page statuses', group: 'business_rules', type: 'text', defaultValue: 'PUBLIC_REVIEW', description: 'Statuses visible on the public review page.' },
