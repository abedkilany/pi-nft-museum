...
const csp = [
  ...
  "img-src 'self' data: blob: https://images.unsplash.com https://*.pinata.cloud https://gateway.pinata.cloud https://ipfs.io https://cloudflare-ipfs.com https://dweb.link",
  "font-src 'self' data:",
